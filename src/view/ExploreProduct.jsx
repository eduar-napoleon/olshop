...
function ExploreProduct(props) {
  ...
  return (
    <div>
      ...
      <section >
        <div className="bg-emc-brokenWhite py-5 rounded-t-lg">
          <div className="grid grid-cols-2 container gap-3 py-3 px-3">
            {data.map((col, idx) => {
              return (
                <div className="flex-col flex flex-wrap bg-emc-white rounded-lg justify-center items-center py-3 px-2 items-center gap-y-3">
                  <img src={col.img} alt="" />
                  <div className="my-3">
                    <p>{col.title}</p>
